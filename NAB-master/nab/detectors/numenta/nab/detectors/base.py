...
class AnomalyDetector(object):
  ...
  ############################################ added for model save while training
  def savemodel(self):
    """
...
def detectDataSet(args):
  ...
  """
  (i, detectorInstance, detectorName, labels, outputDir, relativePath, train) = args ###############anomo

  relativeDir, fileName = os.path.split(relativePath)

  if train == True: ############################################ added for model save while training
    fileName = "training_" + detectorName + "_" + fileName
  else:
  ...
  detectorInstance.initialize(train)
  ...
  ############################################ added for model save while training
  if train == True:
    print "Saving model to tmpDir"
    detectorInstance.savemodel()
  ############################################
